...
export type GetAttestationsByAttesterQueryVariables = Exact<{
  attester: Scalars['String']['input'];
}>;


export type GetAttestationsByAttesterQuery = { __typename?: 'Query', attestations: Array<{ __typename?: 'Attestation', id: string, attester: string, recipient: string, refUID: string, revocable: boolean, revocationTime: number, expirationTime: number, data: string, decodedDataJson: string }> };


export const GetAttestationsByAttesterDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getAttestationsByAttester(variables: GetAttestationsByAttesterQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAttestationsByAttesterQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAttestationsByAttesterQuery>(GetAttestationsByAttesterDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getAttestationsByAttester', 'query', variables);
    }
  };
}
...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useGetAttestationsByAttester(variables: GetAttestationsByAttesterQueryVariables, config?: SWRConfigInterface<GetAttestationsByAttesterQuery, ClientError>) {
      return useSWR<GetAttestationsByAttesterQuery, ClientError>(genKey<GetAttestationsByAttesterQueryVariables>('GetAttestationsByAttester', variables), () => sdk.getAttestationsByAttester(variables), config);
    }
  };
}
